...
CREATE TABLE `web_setting`  (
  ...
  `webDescribe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '网页简短的描述',
...
INSERT INTO `web_setting` VALUES ('NewTube', 1, 5, '/favicon.png', 0, '一个牛逼的视频网站', 1, 1, 1, 0, 50);
